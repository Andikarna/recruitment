...
return new class extends Migration
{
    ...
    {
        Schema::create('resource_salary', function(Blueprint $table){
            $table->id();
            $table->bigInteger('resource_id')->nullable();
            $table->bigInteger('resource_detail_id')->nullable();
            $table->string(column: 'min_salary')->nullable();
            $table->string(column: 'max_salary')->nullable();
            $table->string(column: 'ket_salary')->nullable();
    ...
    {
        Schema::dropIfExists(table: 'resource_salary');
    }
};
