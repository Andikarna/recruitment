    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div id="container-detail" class="bg-white shadow rounded p-4">
                ...
                <form method="POST" action="{{ route('saveCandidate', [$candidate->id]) }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="name" name="name"
                                    value="{{ $candidate->name }}" placeholder="Masukan nama lengkap kandidat" required>
                            </div>

                            <div class="mb-3">
                                <label for="position" class="form-label">Posisi</label>
                                <input type="text" class="form-control" id="position" name="position"
                                    value="{{ $candidate->position }}"  placeholder="Masukan Posisi Kandidat">
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control" id="experience" name="experience"
                                    ...
                                    value="{{ $candidate->experience }}" min="0" >
                            </div>

                            <div class="mb-3">
                                <label for="major" class="form-label">Jurusan</label>
                                <input type="text" class="form-control" id="major" name="major"
                                    placeholder="Masukan jurusan kandidat" value="{{ $candidate->major }}" >
                            </div>
