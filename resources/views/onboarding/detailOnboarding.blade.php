            ...
            <div style="display: flex; flex-direction: column; p-0 m-0">
                <div class="modal-header d-flex justify-content-between align-items-center">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="modal-title" id="addRequestModalLabel">Detail Onboarding</h5>
                    </div>
                        ...
                        <div class="tab-pane fade show active p-2" id="details" role="tabpanel"
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="place_of_birth" name="place_of_birth" disabled
                            ...
                            <div class="row mb-3">
                                <div class="col-md-3">
                                    ...
                                    <div class="input-group">
                                        <select class="form-control" id="blood_type" name="blood_type" disabled>
                                ...
                                <div class="col-md-3">
                                    ...
                                    <input type="text" class="form-control" id="home_phone" name="home_phone" disabled
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="number_id" name="number_id" disabled
                                        value="{{ $onboarding->number_id }}">
                                </div>

                                <div class="col-md-6">
                                    <label for="number_tax" class="form-label">Nomor Tax </label>
                                    <input type="text" class="form-control" id="number_tax" name="number_tax" disabled
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="experience" name="experience" disabled
                                        ...
                                        <div class="p-2 d-flex gap-3">
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio"
                                                    id="special_candidate" name="special_candidate" value="yes" disabled
                                                    {{ $candidate->isSpecial == 1 ? 'checked' : '' }} required>
                                                <label class="form-check-label" for="special_candidate">Ya</label>
                                            </div>
                                            <div class="form-check">
                                                <input disabled class="form-check-input" type="radio"
                                                    id="special_candidate_no" name="special_candidate" value="no" disabled
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="name_emergency" name="name_emergency" disabled
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="number_emergency"
                                        placeholder="Masukan nomor kontak darurat" name="number_emergency" disabled
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="relation_emergency"
                                        placeholder="Masukan hubungan untuk kontak darurat" name="relation_emergency" disabled
                                ...
                                @foreach ($family as $data)
                                    <div class="family-member row mb-3 bordered rounded-lg shadow pt-3 pb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="name_family" disabled
                                                name="name_family[]" placeholder="Nama" value="{{ $data->name }}">
                                        </div>

                                        <div class="col-md-6">
                                            <label for="gender_family" class="form-label">Jenis Kelamin</label>
                                            <select class="form-control" id="gender_family" name="gender_family[]" disabled>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="work_family" disabled
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <select class="form-control" id="education_family" name="education_family[]" disabled>
                                    ...
                                    <div class="educationformal-member row mb-3 bordered rounded-lg shadow pt-3 pb-3"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control"
                                                id="name_institusi_educationformal" disabled
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="city_educationformal" disabled
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="major_educationformal" disabled
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="text" class="form-control" id="gpa_educationformal" disabled
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="date" class="form-control" id="start_educationformal"
                                                name="start_educationformal[]" disabled
                                        ...
                                        <div class="col-md-6 mt-3">
                                            ...
                                            <input type="date" class="form-control" id="end_educationformal"
                                                name="end_educationformal[]" disabled
                                    ...
                                    <div class="skill-member row mb-3 bordered rounded-lg shadow pt-3 pb-3"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="name_skill"
                                                name="name_skill[]" placeholder="Nama Keahlian" disabled
                                                value="{{ $data->name }}">
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-group">
                                                <select class="form-control" id="level_skill" name="level_skill[]" disabled>
                                    ...
                                    <div class="working-member row mb-3 bordered rounded-lg shadow pt-3 pb-3"
                                        ...
                                        <div class="row pt-3 pb-3">
                                            <div class="col-md-6">
                                                ...
                                                <input type="text" class="form-control" id="company_name_working"
                                                    name="company_name_working[]" placeholder="Nama Perusahaan" disabled
                                                    value="{{ $data->name }}">
                                            </div>

                                            <div class="col-md-6">
                                                <label for="industry_working" class="form-label">Industri</label>
                                                <input type="text" class="form-control" id="industry_working" disabled
                                        ...
                                        <div class="row pt-3 pb-3">
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control" id="address_working"
                                                    name="address_working[]" placeholder="Alamat Perusahaan" disabled
                                                    value="{{ $data->address }}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row pt-3 pb-3">
                                            <div class="col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control" id="status_working[]" disabled
                                                        name="status_working[]">
                                        ...
                                        <div class="row pt-3 pb-3">
                                            <div class="col-md-12">
                                                <label for="description_working" class="form-label">Deskripsi
                                                    Pekerjaan</label>
                                                <textarea class="form-control" name="description_working[]" id="description_working[]" disabled>{{ $data->description }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row pt-3 pb-3">
                                            <div class="col-md-12">
                                                ...
                                                <textarea class="form-control" name="project_working[]" id="project_working[]" disabled>{{ $data->project }}</textarea>
                                            </div>
                                        </div>
                                ...
                                <div class="reference row mb-3 bordered rounded-lg shadow pt-3 pb-3"
                                    ...
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="source_refrences"
                                            ...
                                            value="{{ $candidate->reference->name ?? '' }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="phone_refrences"
                                            ...
                                            value="{{ $candidate->reference->number ?? '' }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="position_refrences"
                                            ...
                                            value="{{ $candidate->reference->position ?? '' }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="relation_refrences"
                                            ...
                                            value="{{ $candidate->reference->relation ?? '' }}" disabled>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="working-member row mb-3 bordered rounded-lg shadow pt-3 pb-3">
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="source_aditional"
                                            ...
                                            value="{{ $candidate->additional_information->source ?? '' }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="been_treated_aditional"
                                            ...
                                            value="{{ $candidate->additional_information->been_treated ?? '' }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-12 pt-3">
                                        ...
                                        <input type="text" class="form-control" id="disease_aditional"
                                            ...
                                            value="{{ $candidate->additional_information->disease ?? '' }}" disabled>
                                    </div>
                                    ...
                                    <div class="col-md-12 pt-3">
                                        ...
                                        <textarea type="text" class="form-control" id="strength_aditional" name="strength_aditional"
                                            placeholder="Masukan Kelebihan anda" disabled>{{ $candidate->additional_information->strength ?? '' }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12 pt-3">
                                        ...
                                        <textarea type="text" class="form-control" id="weakness_aditional" name="weakness_aditional"
                                            placeholder="Masukan Kelemahan anda" disabled>{{ $candidate->additional_information->weakness ?? '' }}</textarea>
                                    </div>
                                    ...
                                    <div class="col-md-12 pt-3">
                                        ...
                                        <textarea type="text" class="form-control" id="against_weakness_aditional" name="against_weakness_aditional"
                                            placeholder="Bagaimana cara anda melawan kelamahan anda" disabled>{{ $candidate->additional_information->against_weakness ?? '' }}</textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <div class="row mb-3 bordered rounded-lg shadow pt-3 pb-3" class="row pt-3 pb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="date" class="form-control" id="join_date" name="join_date" disabled
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex justify-content-center align-middle text-center">
                                            <div>
                                                <input type="checkbox" class="form-check-input me-2" id="is_laptop" disabled
                                                    name="is_laptop" {{ $onboarding->laptop != null ? 'checked' : '' }}>
                                                <label class="form-check-label me-3" for="is_laptop">Laptop</label>
                                            </div>
                                            <div class="custom-select-wrapper">
                                                <select class="form-control" id="asset_laptop" name="asset_laptop" disabled
                                    ...
                                    <div class="col-md-6 pt-3">
                                        ...
                                        <input type="date" class="form-control" id="end_contract" name="end_contract" disabled
